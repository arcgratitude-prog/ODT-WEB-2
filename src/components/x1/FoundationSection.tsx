...
export const FoundationSection: React.FC = () => {
  return (
    <section
      ...
      className="relative w-full min-h-[55vh] sm:min-h-[65vh] flex items-center justify-center bg-black px-6 sm:px-12 py-28 sm:py-40 border-t border-b border-white/10"
    >
