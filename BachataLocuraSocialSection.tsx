          ...
          <div className="rounded-3xl p-4 sm:p-8 lg:p-10 border border-fuchsia-500/40 bg-gradient-to-br from-[#180924] via-[#11061a] to-[#0a0310] shadow-[0_0_60px_rgba(217,70,239,0.2)] relative overflow-hidden">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center mb-10">
              ...
              <div className="lg:col-span-7 space-y-4 text-left">
                ...
                <div className="inline-flex items-center gap-2 text-xs font-mono font-bold tracking-widest text-pink-300 uppercase">
                  <Calendar className="w-4 h-4 text-pink-400" />
                  Friday, September 11 • 8:00 PM – 1:00 AM
                </div>

                <p className="text-sm sm:text-base text-purple-100 leading-relaxed max-w-xl">
                  Tampa’s highest-energy monthly Friday night Bachata social. Kick off with an 8 PM workshop by <strong className="text-white">Albina & Isaac</strong>, then dance all night with <strong className="text-white">DJ JR</strong>.
                </p>
              </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center mb-10">
              ...
              <div className="lg:col-span-7 space-y-4 text-left">
                ...
                <div className="inline-flex items-center gap-2 text-xs font-mono font-bold tracking-widest text-slate-300 uppercase">
                  ...
                  Sunday, September 13 • Tampa, FL
                </div>

                <p className="text-sm sm:text-base text-slate-300 leading-relaxed max-w-xl">
                  Tampa’s premier Sunday Bachata social — high-vibe dancing, a special guest presocial class with <strong className="text-white">Albina & Isaac</strong>, and a fire set by <strong className="text-white">DJ JR</strong>.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-300 mt-1">
                      Full entry including presocial class & social dancing. Ends Sep 11th!
                    </p>
                  </div>
                  ...
                  <div className="mt-4 pt-3 border-t border-white/10 flex items-baseline justify-between">
                    <div>
                      ...
                      <span className="text-[10px] text-slate-400 block">*Ends 9/11</span>
                    </div>
                ...
                >
                  <div>
                    ...
                    <p className="text-xs text-slate-300 mt-1">
                      Standard door admission available on Sunday, September 13th.
                    </p>
                  </div>
